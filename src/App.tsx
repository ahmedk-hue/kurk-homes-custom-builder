...
import CustomHomeDesignBuild from './pages/services/CustomHomeDesignBuild';
import BuildOnYourLot from './pages/services/BuildOnYourLot';
import DesignCenterSelections from './pages/services/DesignCenterSelections';
import ModelHomesInspiration from './pages/services/ModelHomesInspiration';
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="services/custom-home-design-build" element={<CustomHomeDesignBuild />} />
            <Route path="services/build-on-your-lot" element={<BuildOnYourLot />} />
            <Route path="services/design-center-selections" element={<DesignCenterSelections />} />
            <Route path="services/model-homes-inspiration" element={<ModelHomesInspiration />} />
